...
const versions: VersionedAlaSQL[] = [
  {
    name: "alasql-0.3.10",
    version: "0.3.10",
    alasql: alasql0310 as AlaSQLInstance,
  },
  {
    name: "alasql-0.4.12",
    version: "0.4.12",
    alasql: alasql0412 as AlaSQLInstance,
  },
  {
    name: "alasql-0.5.10",
    version: "0.5.10",
    alasql: alasql0510 as AlaSQLInstance,
  },
  {
    name: "alasql-0.6.7",
    version: "0.6.7",
    alasql: alasql067 as AlaSQLInstance,
  },
  {
    name: "alasql-0.7.1",
    version: "0.7.1",
    alasql: alasql071 as AlaSQLInstance,
  },
  {
    name: "alasql-1.7.4",
    version: "1.7.4",
    alasql: alasql174 as AlaSQLInstance,
  },
  {
    name: "alasql-1.7.5",
    version: "1.7.5",
    alasql: alasql175 as AlaSQLInstance,
  },
  {
    name: "alasql-2.1.4",
    version: "2.1.4",
    alasql: alasql214 as AlaSQLInstance,
  },
  {
    name: "alasql-2.1.6",
    version: "2.1.6",
    alasql: alasql216 as AlaSQLInstance,
  },
  {
    name: "alasql-2.1.7",
    version: "2.1.7",
    alasql: alasql217 as AlaSQLInstance,
  },
  {
    name: "alasql-2.1.8",
    version: "2.1.8",
    alasql: alasql218 as AlaSQLInstance,
  },
  {
    name: "alasql-2.2.1",
    version: "2.2.1",
    alasql: alasql221 as AlaSQLInstance,
  },
  {
    name: "alasql-2.2.5",
    version: "2.2.5",
    alasql: alasql225 as AlaSQLInstance,
  },
  {
    name: "alasql-2.3.0",
    version: "2.3.0",
    alasql: alasql230 as AlaSQLInstance,
  },
  {
    name: "alasql-2.5.0",
    version: "2.5.0",
    alasql: alasql250 as AlaSQLInstance,
  },
  {
    name: "alasql-2.5.1",
    version: "2.5.1",
    alasql: alasql251 as AlaSQLInstance,
  },
  {
    name: "alasql-2.5.3",
    version: "2.5.3",
    alasql: alasql253 as AlaSQLInstance,
  },
  {
    name: "alasql-2.5.4",
    version: "2.5.4",
    alasql: alasql254 as AlaSQLInstance,
  },
  {
    name: "alasql-3.0.0",
    version: "3.0.0",
    alasql: alasql300 as AlaSQLInstance,
  },
  {
    name: "alasql-3.1.0",
    version: "3.1.0",
    alasql: alasql310 as AlaSQLInstance,
  },
  {
    name: "alasql-3.1.1",
    version: "3.1.1",
    alasql: alasql311 as AlaSQLInstance,
  },
  {
    name: "alasql-4.0.0",
    version: "4.0.0",
    alasql: alasql400 as AlaSQLInstance,
  },
  {
    name: "alasql-4.0.2",
    version: "4.0.2",
    alasql: alasql402 as AlaSQLInstance,
  },
  {
    name: "alasql-4.0.4",
    version: "4.0.4",
    alasql: alasql404 as AlaSQLInstance,
  },
  {
    name: "alasql-4.0.5",
    version: "4.0.5",
    alasql: alasql405 as AlaSQLInstance,
  },
  {
    name: "alasql-4.0.6",
    version: "4.0.6",
    alasql: alasql406 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.0",
    version: "4.1.0",
    alasql: alasql410 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.1",
    version: "4.1.1",
    alasql: alasql411 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.2",
    version: "4.1.2",
    alasql: alasql412 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.3",
    version: "4.1.3",
    alasql: alasql413 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.4",
    version: "4.1.4",
    alasql: alasql414 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.5",
    version: "4.1.5",
    alasql: alasql415 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.7",
    version: "4.1.7",
    alasql: alasql417 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.8",
    version: "4.1.8",
    alasql: alasql418 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.9",
    version: "4.1.9",
    alasql: alasql419 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.10",
    version: "4.1.10",
    alasql: alasql4110 as AlaSQLInstance,
  },
  {
    name: "alasql-4.1.11",
    version: "4.1.11",
    alasql: alasql4111 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.1",
    version: "4.2.1",
    alasql: alasql421 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.2",
    version: "4.2.2",
    alasql: alasql422 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.3",
    version: "4.2.3",
    alasql: alasql423 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.4",
    version: "4.2.4",
    alasql: alasql424 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.5",
    version: "4.2.5",
    alasql: alasql425 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.6",
    version: "4.2.6",
    alasql: alasql426 as AlaSQLInstance,
  },
  {
    name: "alasql-4.2.7",
    version: "4.2.7",
    alasql: alasql427 as AlaSQLInstance,
  },
  {
    name: "alasql-4.3.0",
    version: "4.3.0",
    alasql: alasql430 as AlaSQLInstance,
  },
  {
    name: "alasql-4.3.1",
    version: "4.3.1",
    alasql: alasql431 as AlaSQLInstance,
  },
  {
    name: "alasql-4.3.2",
    version: "4.3.2",
    alasql: alasql432 as AlaSQLInstance,
  },
  {
    name: "alasql-4.3.3",
    version: "4.3.3",
    alasql: alasql433 as AlaSQLInstance,
  },
  {
    name: "alasql-4.4.0",
    version: "4.4.0",
    alasql: alasql440 as AlaSQLInstance,
  },
  {
    name: "alasql-4.5.0",
    version: "4.5.0",
    alasql: alasql450 as AlaSQLInstance,
  },
  {
    name: "alasql-4.5.1",
    version: "4.5.1",
    alasql: alasql451 as AlaSQLInstance,
  },
  {
    name: "alasql-4.5.2",
    version: "4.5.2",
    alasql: alasql452 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.0",
    version: "4.6.0",
    alasql: alasql460 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.1",
    version: "4.6.1",
    alasql: alasql461 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.2",
    version: "4.6.2",
    alasql: alasql462 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.3",
    version: "4.6.3",
    alasql: alasql463 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.4",
    version: "4.6.4",
    alasql: alasql464 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.5",
    version: "4.6.5",
    alasql: alasql465 as AlaSQLInstance,
  },
  {
    name: "alasql-4.6.6",
    version: "4.6.6",
    alasql: alasql466 as AlaSQLInstance,
  },
  {
    name: "alasql-4.7.0",
    version: "4.7.0",
    alasql: alasql470 as AlaSQLInstance,
  },
  {
    name: "alasql-4.8.0",
    version: "4.8.0",
    alasql: alasql480 as AlaSQLInstance,
  },
  {
    name: "alasql-4.9.0",
    version: "4.9.0",
    alasql: alasql490 as AlaSQLInstance,
  },
  {
    name: "alasql-4.10.0",
    version: "4.10.0",
    alasql: alasql4100 as AlaSQLInstance,
  },
  {
    name: "alasql-4.10.1",
    version: "4.10.1",
    alasql: alasql4101 as AlaSQLInstance,
  },
];

const ALASQL_REPO_URL = "https://github.com/AlaSQL/alasql.git";
const NEXT_DIR = path.join(process.cwd(), "/.alasql-next");

async function loadAlasqlNext(): Promise<VersionedAlaSQL | null> {
  try {
    console.log("🔧 Building AlaSQL from GitHub...");
    ...
    if (fs.existsSync(NEXT_DIR)) {
      ...
      execSync(
        `git clone --depth 1 --branch develop ${ALASQL_REPO_URL} ${NEXT_DIR}`,
        {
          stdio: "pipe",
        }
      );
    ...
    execSync(`cd ${NEXT_DIR} && npm install`, {
      cwd: NEXT_DIR,
      stdio: "pipe",
    });
    ...
    const buildCommand = packageJson.scripts?.["build-only"]
      ? "npm run build-only"
      : "npm run build";
    ...
    const distPath = path.join(NEXT_DIR, "dist", "alasql.js");
    ...
    console.log(`   ✅ AlaSQL NEXT build complete (commit: ${commitHash})`);
...
function runBenchmark(
  ...
  testCase: TestCase,
  iterations: number
): { duration: number; iterations: number } {
  // Setup
...
async function main() {
  ...
  const NEXT = await loadAlasqlNext();
  if (NEXT) {
    versionsToRun.push(NEXT);
  }
